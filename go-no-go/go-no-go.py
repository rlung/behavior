...
class InputManager(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.var_us2_delay.set(1000)
        self.var_us2_dur.set(50)
        self.var_response_period.set(500)
        self.var_response_percent.set(50)
        ...
        self.var_response_dur.set(1500)
    ...
    def set_params(self):
        ...
        frame_vac.grid(row=3, column=0, sticky='we', **opts_frame1)
        ...
        if session_type in {type_classical, type_gonogo, type_gonogo_run}:
            ...
            if session_type == type_classical:
                ...
                if session_type == type_gonogo_run:
                    ...
                    frame_cr.grid(row=2, column=0, sticky='we', **opts_frame1)
                    frame_cr.columnconfigure(0, weight=1)
                    frame_cr_params = ttk.Frame(frame_cr)
                    frame_cr_check = ttk.Frame(frame_cr)
                    frame_cr_params.grid(row=0, column=0, sticky='e', **opts_frame1)
                    frame_cr_check.grid(row=0, column=1, sticky='e', **opts_frame1)

                    ttk.Label(frame_cr_params, text='Min', anchor='center').grid(row=0, column=1, sticky='we')
                    ttk.Label(frame_cr_params, text='Max', anchor='center').grid(row=0, column=2, sticky='we')
                    ttk.Label(frame_cr_params, text='CR0: ', anchor='e').grid(row=1, column=0, sticky='e')
                    ttk.Label(frame_cr_params, text='CR1: ', anchor='e').grid(row=2, column=0, sticky='e')
                    ttk.Entry(frame_cr_params, textvariable=self.var_cr0_min, **opts_entry10).grid(row=1, column=1, sticky='w')
                    ttk.Entry(frame_cr_params, textvariable=self.var_cr0_max, **opts_entry10).grid(row=1, column=2, sticky='w')
                    ttk.Entry(frame_cr_params, textvariable=self.var_cr1_min, **opts_entry10).grid(row=2, column=1, sticky='w')
                    ttk.Entry(frame_cr_params, textvariable=self.var_cr1_max, **opts_entry10).grid(row=2, column=2, sticky='w')

                    ttk.Label(frame_cr_check, text='', anchor='center').grid(row=0, column=1, sticky='we')
                    ttk.Label(frame_cr_check, text='Check period (ms): ', anchor='e').grid(row=1, column=3, sticky='e')
                    ttk.Label(frame_cr_check, text='Response percent: ', anchor='e').grid(row=2, column=3, sticky='e')
                    ttk.Entry(frame_cr_check, textvariable=self.var_response_period, **opts_entry10).grid(row=1, column=4, sticky='w')
                    ttk.Entry(frame_cr_check, textvariable=self.var_response_percent, **opts_entry10).grid(row=2, column=4, sticky='w')
    ...
    def start(self, code_start='E'):
        ...
        self.grp_behav.create_dataset(name='lick', dtype='int32', shape=(2, n_movement_frames), chunks=chunk_size)
        self.grp_behav.create_dataset(name='lick_form', dtype='int32', shape=(2, n_movement_frames), chunks=chunk_size)
        self.grp_behav.create_dataset(name='movement', dtype='int32', shape=(2, n_movement_frames), chunks=chunk_size)
        self.grp_behav.create_dataset(name='trial_start', dtype='int32', shape=(2, n_trials), chunks=chunk_size)
        self.grp_behav.create_dataset(name='trial_signal', dtype='int32', shape=(2, n_trials), chunks=chunk_size)
        self.grp_behav.create_dataset(name='cs', dtype='int32', shape=(2, n_trials), chunks=chunk_size)
        self.grp_behav.create_dataset(name='us', dtype='int32', shape=(2, n_movement_frames), chunks=chunk_size)
        self.grp_behav.create_dataset(name='response', dtype='int32', shape=(2, n_trials), chunks=chunk_size)
