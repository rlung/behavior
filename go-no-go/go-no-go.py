...
class InputManager(ttk.Frame):
    ...
    def set_params(self):
        ...
        if session_type == type_classical:
            ...
            tk.Label(frame_trial, text='Response period (ms): ', anchor='e').grid(row=0, column=0, sticky='e')
            tk.Label(frame_trial, text='Response min (au): ', anchor='e').grid(row=1, column=0, sticky='e')
            tk.Label(frame_trial, text='Response max (au): ', anchor='e').grid(row=2, column=0, sticky='e')
            self.entry_response_period.grid(row=0, column=1, sticky='w')
            self.entry_cr0_min.grid(row=1, column=1, sticky='w')
            self.entry_cr0_max.grid(row=2, column=1, sticky='w')
