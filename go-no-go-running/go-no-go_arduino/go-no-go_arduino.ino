...
void GetParams() {
  ...
  consumption_dur = parameters[37];
  vac_dur = parameters[38];
  trial_signal_offset = parameters[39];
  trial_signal_dur = parameters[40];
  trial_signal_freq = parameters[41];
  grace_dur = parameters[42];
  response_dur = parameters[43];
  timeout_dur = parameters[44];
  image_all = parameters[45];
  image_ttl_dur = parameters[46];
  track_period = parameters[47];
